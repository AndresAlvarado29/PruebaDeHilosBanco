 ...
 * @author Andres
 */
public class Hilo9 implements Runnable {
    ...
    public Hilo9(int kilometro, JLabel cliente, String nombre, int id, JTextArea area, JLabel resultado1) {
    ...
    public Hilo9(int kilometro, JLabel cliente, String nombre) {
        this.kilometro = kilometro;
        this.cliente = cliente;
        this.nombre = nombre;
    }
    ...
    cliente.setLocation(225, 30);
    process = "Cliente "+ id +": " +"esta retirando 20$"+ "\n";    
    area.append(process);
     try {
            Thread.sleep(1000);
