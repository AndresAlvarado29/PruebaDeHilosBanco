 ...
 * @author Andres
 */
public class Hilo8 implements Runnable {
    ...
    public Hilo8(int kilometro, JLabel cliente, String nombre, int id, JTextArea area, JLabel resultado1) {
    ...
    public Hilo8(int kilometro, JLabel cliente, String nombre) {
        this.kilometro = kilometro;
        this.cliente = cliente;
        this.nombre = nombre;
    }
    ...
    cliente.setLocation(125, 30);
    process = "Cliente "+ id +": " +"esta depositando 50$"+ "\n";    
    area.append(process);
     try {
            Thread.sleep(1000);
