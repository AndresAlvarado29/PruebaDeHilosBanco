 ...
 * @author Andres
 */
public class Hilo10 implements Runnable {
    ...
    public Hilo10(int kilometro, JLabel cliente, String nombre, int id, JTextArea area, JLabel resultado1) {
    ...
    public Hilo10(int kilometro, JLabel cliente, String nombre) {
        this.kilometro = kilometro;
        this.cliente = cliente;
        this.nombre = nombre;
    }
