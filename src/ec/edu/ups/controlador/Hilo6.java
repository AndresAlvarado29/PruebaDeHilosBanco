...
public class Hilo6 implements Runnable {
    ...
    public Hilo6(int kilometro, JLabel cliente, String nombre, int id, JTextArea area, JLabel resultado1) {
    ...
    public Hilo6(int kilometro, JLabel cliente, String nombre) {
        this.kilometro = kilometro;
        this.cliente = cliente;
        this.nombre = nombre;
    }
    ...
    cliente.setLocation(225, 70);
    process = "Cliente "+ id +": " +"esta retirando 50$"+ "\n";    
    area.append(process);
     try {
            Thread.sleep(1000);
