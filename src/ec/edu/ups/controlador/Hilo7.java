 ...
 * @author Andres
 */
public class Hilo7 implements Runnable {
    ...
    public Hilo7(int kilometro, JLabel cliente, String nombre, int id, JTextArea area, JLabel resultado1) {
    ...
    public Hilo7(int kilometro, JLabel cliente, String nombre) {
        this.kilometro = kilometro;
        this.cliente = cliente;
        this.nombre = nombre;
    }
